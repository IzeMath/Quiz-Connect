 ...
 */
@WebServlet("/GameServletmob")
public class GameServletmob extends HttpServlet {
	...
	protected void doGet(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/room_mob.jsp").forward(request, response);
	}
